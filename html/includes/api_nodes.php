	...
	if ($p['type'] == "qemu") {
		$output['data']['options']['qemu_version'] =  Array(
			...
			'list'  => Array (
				...
				'' => (isset($p['qemu_version'])?$p['qemu_version']:"(default 2.4.0)")
			));
		$output['data']['options']['qemu_arch'] =  Array(
			...
			'list'  => Array (
				'i386' => 'i386',
				'x86_64' => 'x86_64',
				// '' => 'tpl'.( isset($p['qemu_arch'])?'('.$p['qemu_arch'].')':"")
				'' => ( isset($p['qemu_arch'])?$p['qemu_arch']:"")
			));
		$output['data']['options']['qemu_nic'] =  Array(
			...
			'list' => Array (
				...
				'vmxnet3' => 'vmxnet3',
				// '' => 'tpl'.( isset($p['qemu_nic'])?'('.$p['qemu_nic'].')':"(e1000)")
				'' => ( isset($p['qemu_nic'])?$p['qemu_nic']:"(e1000)")
			));
